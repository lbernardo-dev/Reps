...
struct MainTabView: View {
  ...
  @AppStorage("hasCompletedAppGuidedTour") private var hasCompletedAppGuidedTour = false
  ...
  var body: some View {
    ...
    return
      ...
      .overlay {
        if showGuidedTour || store.showAppGuidedTour {
          AppGuidedTourView(
            isPresented: Binding(
              get: { showGuidedTour || store.showAppGuidedTour },
              set: { newValue in
                showGuidedTour = newValue
                store.showAppGuidedTour = newValue
              }
            ),
            selectedTab: $selectedTab,
            onFinish: {
              hasCompletedAppGuidedTour = true
            }
          )
        }
      }
      ...
      .onAppear {
        ...
        if !hasCompletedAppGuidedTour && store.userProfile.onboardingCompleted {
          showGuidedTour = true
        }
      }
