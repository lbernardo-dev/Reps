...
private func settingsDisplayText(_ key: String) -> String {
    String(localized: String.LocalizationValue(key), bundle: .main, locale: RepsLocalization.locale)
}

private func settingsFormatText(_ key: String, _ arguments: CVarArg...) -> String {
    String(
        format: String(localized: String.LocalizationValue(key), bundle: .main, locale: RepsLocalization.locale),
        locale: RepsLocalization.locale,
        arguments: arguments
    )
}
