...
struct EquipmentRoutineWizardView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(localizedString("equipment_routine"))
            ...
            .confirmationDialog(
                localizedString("equip_routine_confirm_title"),
                isPresented: $showConfirmCreate,
                titleVisibility: .visible
            ) {
                Button(localizedString("create_routine")) { performCreate() }
                Button(localizedString("cancel"), role: .cancel) {}
            } message: {
                Text(localizedString("equip_routine_confirm_message"))
            }
        }
    }
        ...
        VStack(alignment: .leading, spacing: 18) {
            ...
            PulseCard {
                VStack(alignment: .leading, spacing: 14) {
                    Text(localizedString("available_equipment"))
                        .font(.headline)
                    LazyVGrid(
                    ...
                    Text(localizedString("onboarding_equipment_refine_hint"))
    ...
    private var planNameField: some View {
        PulseCard {
            VStack(alignment: .leading, spacing: 8) {
                Text(localizedString("equip_routine_plan_name"))
                ...
                HStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 3) {
                        Text(planName.isEmpty ? autoGeneratedName : planName)
                            .font(.headline)
                        Text(localizedString("equip_routine_preview_label"))
                            .font(.caption.weight(.semibold))
                            .foregroundStyle(PulseTheme.secondaryText)
                    }
                    Spacer()
            ...
            HStack(spacing: 12) {
                if step > 0 {
                    Button {
                        ...
                        HStack(spacing: 6) {
                            ...
                            Text(localizedString("equip_routine_back"))
                ...
                Button {
                    ...
                    Text(step < totalSteps - 1
                         ...
                         : localizedString("create_routine"))
                        .font(.headline.weight(.bold))
        ...
        PulseCard(contentPadding: 18) {
            VStack(alignment: .leading, spacing: 18) {
                HStack(alignment: .firstTextBaseline) {
                    Text(localizedString("onboarding_schedule_days_label"))
                        .font(.headline)
                    Spacer()
                    Text(dayHint)
                        .font(.caption.weight(.semibold))
                ...
                HStack(alignment: .lastTextBaseline, spacing: 8) {
                    ...
                    Text(localizedString("onboarding_schedule_days_unit"))
