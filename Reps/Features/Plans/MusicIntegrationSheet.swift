...
struct MusicIntegrationSheet: View {
    ...
    private var appleMusicView: some View {
        VStack(spacing: 20) {
            ...
            // Curated / Loaded Apple Music Playlists
            VStack(alignment: .leading, spacing: 14) {
                Text(isAppleMusicAuthorized ? "Tus Playlists y Recomendadas" : "Playlists Recomendadas")
                    .font(.headline)
                ...
                let filtered = curatedAppleMusicPlaylists.filter { playlist in
